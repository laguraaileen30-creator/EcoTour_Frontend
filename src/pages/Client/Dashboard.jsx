  ...
  return (
    <div className="client-portal">
      ...
      <div className="ct-main">
        <header className="ct-header px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3 flex-1 max-w-xl">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-full pl-9 pr-4 py-1.5 text-xs outline-none transition-all"
              />
            </div>
          </div>
          ...
          <div className="ct-header-right flex items-center gap-4">
            ...
            <div className="ct-user flex items-center gap-2.5">
              ...
              <div>
                ...
                <small className="text-[10px] flex items-center gap-1">Explorer <ChevronDown size={12} /></small>
              </div>
            </div>
          </div>
        </header>
